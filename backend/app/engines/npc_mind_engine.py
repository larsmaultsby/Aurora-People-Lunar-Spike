    ...
    async def update_npc_thoughts(
        ...
        _NPC_MIND_PROMPTS = {
            "en": (
                ...
                "IMPORTANT: Only include NPCs with explicit proper names that already appear in the narrative. Do not invent a name merely to satisfy this requirement. "
            ...
            "pt-br": (
                ...
                "na cena atual. "
                "IMPORTANTE: Inclua APENAS NPCs com nomes próprios explícitos que já apareçam na narrativa. Não invente um nome apenas para satisfazer esse requisito. "
