...
class NarratorEngine:
    ...
    _NARRATOR_RULES = {
        "en": (
            ...
            "- When mentioning a character by name in narration, prefix that character's existing full name with the literal @ character. Do not invent or copy a sample name merely to demonstrate the tagging format. This applies to ALL named characters and NPCs. Do NOT use @ in dialogue lines spoken by characters, only in narration text.\n"
        ...
        "pt-br": (
            ...
            "- Ao mencionar um personagem pelo nome na narração, prefixe o nome completo já existente desse personagem com o caractere literal @. Não invente nem copie um nome de exemplo apenas para demonstrar o formato da marcação. Isso se aplica a TODOS os personagens e NPCs nomeados. NÃO use @ em falas de diálogo dos personagens, apenas no texto narrativo.\n"
